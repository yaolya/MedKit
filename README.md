...
У пользователей есть возможность составлять списки покупок, чтобы сразу добавлять в них закончившиеся препараты и препараты с вышедшим сроком годности. В списке  указывается количество требуемых единиц товара. При покупке после введения пользователем серии, номера и срока годности приобретенных препаратов, список автоматически обновляется.  
## Наименование
MedKit
## Предметная область
