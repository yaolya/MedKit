...
function Medicaments() {
    ...
    const [fetchMedicaments, isMedicamentsLoading, medicamentError] = useFetching(async (limit, page) => {
        ...
        CategoriesApi.getAllCategories().then(function(response2){
            if (typeof response2 != 'undefined'){setCategories(response2.data)}
    ...
    return (
        <div className="medicaments">
            ...
            ? <h1>loading...</h1>
            : <MedicamentsList addImage={addImage} edit={editMedicament} remove={removeMedicament} medicaments={sortedAndSearchedMedicaments} categories={categories} title="medicaments"/>
            }
